...
-- 回答前压缩只推进工作上下文边界，不删除或修改原始聊天消息。
CREATE TABLE agent_context_compaction (
    id BIGINT NOT NULL AUTO_INCREMENT, user_id BIGINT NOT NULL,
    conversation_id BIGINT NOT NULL, context_boundary INT NOT NULL,
    previous_turn_id BIGINT NOT NULL, through_turn_id BIGINT NOT NULL,
    summary_text TEXT NOT NULL, memory_enabled TINYINT(1) NOT NULL,
    state VARCHAR(16) NOT NULL, created_at DATETIME(6) NOT NULL, ready_at DATETIME(6) NULL,
    PRIMARY KEY (id),
